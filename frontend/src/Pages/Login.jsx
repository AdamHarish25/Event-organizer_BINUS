import { FaEnvelope, FaLock, FaSuperpowers, FaUser } from "react-icons/fa"; // Import icons from react-icons
  ...
  return (
    <div className={className.container}>
      ...
      <div className={className.formContainer}>
        ...
        <p className="text-sm mb-6">Please log in to access your account.</p>
